    ...
    <div className="w-full min-h-screen bg-[#040704] relative overflow-hidden flex flex-col">
      ...
      <motion.div
              ...
              `,
					...
					>
							A nationally recognised educator and Web3 leader, Qamar began his journey as a Quality
Control Engineer in the UAE before pivoting into teaching and the blockchain space. Today,
he has supported 50+ Web3 projects and actively contributes as IR at Kommunitas and
Ambassador at PancakeSwap & ApeX Protocol.
Known for breaking down complex topics like Blockchain, DeFi, and Bitcoin into simple,
actionable insights, Qamar is a sought-after speaker across India, inspiring builders to learn,
build, and grow in Web3.
						<div className="my-6"></div>
						<p className="italic">
							"Focus on learning first, remain curious, and be patient. The opportunities will follow in time."
							- Qamar Rizwani
						</p>
						</p>
              ...
              `,
					...
					>
						gen.xyz is a next-generation domain platform powering innovators across Web3, AI,
startups, and the creator economy. Trusted by millions worldwide, .xyz domains have
become the go-to choice for launching bold ideas and future-first projects on the internet.
As the Sponsor of B, gen.xyz fuels innovation at the intersection of Web2 × Web3,
empowering students and developers to build, brand, and ship without limits.	
						</p>
