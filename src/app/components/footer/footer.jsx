  ...
  return (
    <div className="bg-[#050505] text-white overflow-hidden">
      <div id="footer-trigger" ref={triggerRef} className="relative">
        ...
        <div className="relative w-full h-[400px] md:h-[600px] mt-auto flex justify-center items-end pointer-events-none">
          <div className="absolute w-full h-[600px] bottom-[0px] md:bottom-[-180px] z-10 flex justify-center">
            ...
            <div className="absolute top-[-250px] md:top-[-500px] left-0 w-full h-[800px] overflow-hidden z-0">
              <div id="anim-glow" className={`w-full h-full origin-center ${styles.opacity0Start}`}>
                <div className="absolute left-1/2 -translate-x-1/2 bottom-[-50px] md:bottom-[-100px]
                ...
                <div className="absolute left-1/2 -translate-x-1/2 bottom-[-100px] md:bottom-[-150px]
                ...
                <div className="absolute left-1/2 -translate-x-1/2 bottom-[20px] md:bottom-[-20px]
            ...
            <div className={`absolute inset-0 z-20 ${styles.trayFadeMask}`}>
              <svg className="hidden md:block w-full h-full" viewBox="0 0 1440 600" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
                <path 
                  id="line-desktop" 
              ...
              <svg className="block md:hidden w-full h-full" viewBox="0 0 390 400" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
                <path 
                  id="line-mobile" 
            ...
            >
              ...
              <img src="/svgs/bear-shape.svg" className={`${styles.preventSelect} absolute inset-0 w-full h-full opacity-20 z-0`} alt="Bear Shape" />

              <div className="absolute inset-0 z-30 flex flex-col justify-center items-center pt-16">
                <div id="anim-text" className={`${styles.opacity0Start} flex flex-col items-center`}>
                  <h1 className="text-[104px] font-light leading-none tracking-tighter drop-shadow-2xl">
                    <span className="bg-gradient-to-b from-white via-gray-100 to-gray-500 bg-clip-text text-transparent">B</span>
        ...
        <footer className="relative z-30 bg-[#050505] pb-12 pt-6 px-6 md:px-24 pointer-events-auto">
          <div className="flex flex-col md:flex-row justify-between items-center gap-10 md:gap-12">
            
            {/* Address */}
            <div id="footer-item-1" className={`${styles.opacity0Start} space-y-6 w-full md:w-auto text-center md:text-left`}>
              <img src="/svgs/vinnovate-logo.svg" className="w-32 md:w-44 mx-auto md:mx-0" alt="Vinnovate" />
            ...
            {/* Socials & Button */}
            <div id="footer-item-2" className={`${styles.opacity0Start} flex flex-col items-center md:items-end gap-8 md:gap-10 w-full md:w-auto`}>
              <div className="flex gap-8 justify-center">
                {/* Ensure you have these icons in public/svgs/ */}
                <a href="https://www.instagram.com/vinnovateit/?hl=en" target="_blank" rel="noreferrer">
                  <img src="/svgs/instagram.svg" className={`w-6 h-6 md:w-8 md:h-8 filter brightness-0 invert opacity-80 ${styles.hoverGreenFilter}`} alt="Instagram" />
                </a>
                <a href="https://x.com/v_innovate_it?lang=en" target="_blank" rel="noreferrer">
                  <img src="/svgs/twitter.svg" className={`w-6 h-6 md:w-8 md:h-8 filter brightness-0 invert opacity-80 ${styles.hoverGreenFilter}`} alt="Twitter" />
                </a>
                <a href="https://in.linkedin.com/company/v-innovate-it" target="_blank" rel="noreferrer">
                  <img src="/svgs/linkedin.svg" className={`w-6 h-6 md:w-8 md:h-8 filter brightness-0 invert opacity-80 ${styles.hoverGreenFilter}`} alt="LinkedIn" />
                </a>
                <a href="https://github.com/vinnovateit" target="_blank" rel="noreferrer">
                  <img src="/svgs/github.svg" className={`w-6 h-6 md:w-8 md:h-8 filter brightness-0 invert opacity-80 ${styles.hoverGreenFilter}`} alt="Github" />
                </a>
                <a href="https://www.facebook.com/VinnovateIT/" target="_blank" rel="noreferrer">
                  <img src="/svgs/facebook.svg" className={`w-6 h-6 md:w-8 md:h-8 filter brightness-0 invert opacity-80 ${styles.hoverGreenFilter}`} alt="Facebook" />
                </a>
              </div>
