...
const FAQ_DATA = {
  "General FAQS": [
    { q: "What is a hackathon?", a: "A hackathon is a social coding event where programmers collaborate to build projects." },
    { q: "What happens at a hackathon?", a: "Participants form teams and build a working prototype within a set time limit." },
    { q: "Do I need to know how to code?", a: "Not necessarily! Teams also need designers and project managers." },
    { q: "Do I need to have a team?", a: "No, you can join solo and find a team during our team-building sessions." },
    { q: "Who organizes B³?", a: "B³ is organized by a dedicated team of student developers." },
  ],
  "B³ FAQS": [
    { q: "What is the theme of B³?", a: "The theme focuses on innovation in blockchain and sustainable technology." },
    { q: "What is the format of the B³?", a: "It is a 36-hour intensive hybrid hackathon." },
    { q: "Can I join physically?", a: "Yes, we have a physical venue for local participants." },
    { q: "What is the schedule?", a: "The full schedule will be emailed to registered participants." },
    { q: "Is there a prize pool?", a: "Yes, there are major prizes for top teams and specific track winners." },
  ],
  "Blockchain FAQS": [
    { q: "What should I bring?", a: "Bring your laptop, chargers, a valid ID, and your passion!" },
    { q: "I don't have a team!", a: "We'll have a team-matching session at the start of the event." },
    { q: "I don't have any ideas!", a: "We provide mentorship and brainstorming workshops to help." },
  ],
  "Sign up FAQS": [
    { q: "Where can I register?", a: "You can register through the 'Register Now' button on our page." },
    { q: "When is the deadline?", a: "Registration closes one week before the event starts." },
    { q: "Do I need to be a student?", a: "Yes, but we also allow recent graduates and hobbyists." },
  ]
};
...
const FAQ = () => {
  ...
  return (
    <div className="relative min-h-screen w-full bg-[#050505] text-white flex flex-col items-center justify-start md:justify-center font-sans p-4 md:p-8 overflow-hidden">
      ...
      <h1 className="relative z-10 text-4xl md:text-7xl font-extralight tracking-[0.2em] mt-12 mb-8 md:mb-12 text-gray-100 uppercase">
        FAQs
      </h1>
      ...
      <div className="relative z-10 w-full max-w-6xl bg-[#0d0d0d]/80 backdrop-blur-md rounded-[2rem] border border-white/10 shadow-2xl overflow-hidden mb-12">
          ...
          {categories.map((tab, index) => (
            <button
              ...
              className={`relative flex-1 py-4 md:py-6 text-[10px] md:text-sm font-bold uppercase tracking-[0.1em] transition-colors duration-500 z-10 outline-none ${
                page === index ? "text-white" : "text-gray-500 hover:text-gray-400"
              }`}
            >
        ...
        <div className="relative p-4 md:p-12 min-h-[500px] overflow-hidden">
          ...
          <div 
            ...
            style={{
                background: 'conic-gradient(from 190deg at 50% 50%, transparent 0deg, rgba(34, 197, 94, 0.4) 40deg, transparent 90deg)',
                filter: 'blur(120px)',
                ...
                {FAQ_DATA[activeTab].map((item, index) => (
                  <div key={index} className="w-full">
                    ...
                    >
                      ...
                      <div className={`flex-shrink-0 p-1.5 md:p-2 rounded-lg md:rounded-xl transition-all duration-300 ${
                        openIndex === index 
                          ? 'rotate-180 bg-green-500 shadow-[0_0_15px_rgba(34,197,94,0.5)]' 
                          : 'bg-white/10'
                      }`}>
                        <ChevronDown size={18} className="md:w-6 md:h-6 text-white" />
                      </div>
                    </button>
                    ...
                    <AnimatePresence>
                      {openIndex === index && (
                        <motion.div
                          initial={{ height: 0, opacity: 0, scale: 0.94, transformOrigin: 'top' }}
